...
{
    var h = accessory.hue || accessory.value.split(':')[1], s = accessory.saturation || accessory.value.split(':')[2] * 2, l = accessory.value.split(':')[0] == 'true' ? accessory.brightness || accessory.value.split(':')[3] / 4 : 0;
    var r = 0, g = 0, b = 0;
